...
function onDeviceReady() {
    ...
    var NOTEAPP = {
        ...
        displayNotes: function(){
            ...
            if(! $.isEmptyObject(objNotes)){
                ...
                for(n in objNotes){
                    ...
                    $('.swipeout-content a', newItem).text(n);
        ...
        bindings: function(){
            ...
            // *******************************************************************
            $(document).on('click', '#memoList li .swipeout-content a', function(){
            ...
            //gestionnaire de l'ajout de note dans la page ADD
            // ****************************************************************************
            ...
            // ****************************************************************************
            $(document).on('click', "[data-name='details'] #deleteBtn", function(){
            
            var title=$("[data-name='details'] .page-content .title").text();
            
            _noteapp.deleteNote(title);
            
             mainView.router.back();
            
            _noteapp.displayNotes();

            }) // Fin bouton effacer de la page détail
          
            
    // gestionnaire du swipeout
    // ***************************************************************************		
		$(document).on('swipeout:deleted', '.swipeout', function(){
            
            var title=$(".swipeout-content a", this).text();
